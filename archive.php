...
<!-- END SIDEBAR -->
	...
	<div id="content" class="archive multi-posts" role="main">
	  ...
	  <?php /* If this is an author archive */ } elseif (is_author()) { ?>
 	  ...
 	  <?php } ?>
		...
		<div <?php post_class() ?>>
				...
				<p class="postmetadata meta-info"><?php the_tags('Tags: ', ', ', '<br />'); ?> Posted in <?php the_category(', ') ?> | <?php edit_post_link('Edit', '', ' | '); ?>  <?php comments_popup_link('No Comments &#187;', '1 Comment &#187;', '% Comments &#187;'); ?></p>
