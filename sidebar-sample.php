...
<aside id="primary">
	...
	<?php if ( is_active_sidebar('sample') ) : ?><?php /*?> you'll need to register your sidebar's name in functions.php <?php */?>
    ...
    <?php /*?> replace this code with whatever default code you want to display your sidebar if no widgets are active <?php */?>
      <h3>Sample Sidebar</h3>
        <p>Look, it's the Sample Sidebar!</p>
    ...
    <?php /*?> end default code to display in sample sidebar <?php */?>
